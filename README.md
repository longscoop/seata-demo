...
service {
  ...
  default.grouplist = "127.0.0.1:8099"   此配置作用参考:https://blog.csdn.net/weixin_39800144/article/details/100726116
...
registry {
  ...
  eureka {
    serviceUrl = "http://admin:admin@localhost:8761/eureka"  修改这里
    application = "default"  
    weight = "1"
  }
  redis {
...
seata:
  ...
  service:
    vgroup-mapping:
      fsp_tx_group: seata 这个fsp_tx_group自定义命名很重要，server，client都要保持一致
```
